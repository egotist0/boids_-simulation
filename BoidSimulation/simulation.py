import taichi as ti
from .config import boids_num, width, height, boids_size, max_speed,neighbor_radius,separation_radius, alignment_weight, cohesion_weight, separation_weight, dt
from .models import speeds, positions, screen
